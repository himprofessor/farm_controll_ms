  ...
  <div class="flex items-center justify-center min-h-screen bg-blue-50">
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
      ...
      <div class="text-center mb-6">
        <img :src="logo" alt="Farm Logo" class="mx-auto mb-2 w-10 h-10" />
      ...
      <form @submit.prevent="login">
        ...
        <button
          type="submit"
          :disabled="loading"
          class="w-full bg-green-600 text-white p-2 rounded hover:bg-green-700 transition disabled:opacity-50 disabled:cursor-not-allowed"
        >
